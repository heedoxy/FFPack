...
$(document).ready(function () {
    ...
    if($('#editor-demo-x1').length) {
        CKEDITOR.replace('editor-demo-x1', {
    ...
    if($('#editor-demo-x2').length) {
        CKEDITOR.replace('editor-demo-x2', {
            // Define the toolbar groups as it is a more accessible solution.
            toolbarGroups: [{
                "name": "basicstyles",
                "groups": ["basicstyles"]
    ...
    if($('#editor-demo-x3').length) {
        CKEDITOR.replace('editor-demo-x3', {
            // Define the toolbar groups as it is a more accessible solution.
            toolbarGroups: [{
                "name": "basicstyles",
                "groups": ["basicstyles"]
    ...
    if($('#editor-demo-x4').length) {
        CKEDITOR.replace('editor-demo-x4', {
            // Define the toolbar groups as it is a more accessible solution.
            toolbarGroups: [{
                "name": "basicstyles",
                "groups": ["basicstyles"]
